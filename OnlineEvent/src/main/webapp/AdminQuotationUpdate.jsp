...
function validatePhoneNumber() {
    var phoneNumber = document.forms["updateAdmin"]["phone"].value;
 ...
 <!--Start Header-->
      ...
      <nav>
          ...
          <div class="navigation-bar">
              <ul>
                  ...
                  <li class="active"><a href="#">QUATATION<span class="underline"></span></a></li>
  ...
  <!--End Header-->
    ...
    <c:forEach var="qut" items="${qutDetails}">
        <form action="updateAdmin" method="post" name="updateAdmin" onsubmit="return validatePhoneNumber()">
